...
def profilepage(request):
    ...
    if not logged_in:
        ...
        saved_threads = [CommunityDiscussions.objects.get(discussion_id=int(discussion_id)).discussion_title for discussion_id in user_data.user_saved_threads.split(",")]
        context = {
            'title': 'Profile',
            'logged_in': logged_in,
